...
$mod_info = array(
	...
	'description' => __('Galeria zdjęc z kategoriami i albumami oraz ładnym efektem :prettyPhoto', array(':prettyPhoto' => '<a href="http://www.no-margin-for-errors.com/projects/prettyphoto-jquery-lightbox-clone/" title="Pretty Photo">Pretty Photo</a>')),
...
$new_table[4] = array(
	...
	"(
		...
		`comment` TINYINT UNSIGNED NOT NULL DEFAULT '1',
		`rating` TINYINT UNSIGNED NOT NULL DEFAULT '0',
		`watermark` TINYINT UNSIGNED NOT NULL DEFAULT '1',
		`description` varchar(255) DEFAULT NULL,
		`album` MEDIUMINT UNSIGNED NOT NULL DEFAULT '1',
		`user` MEDIUMINT UNSIGNED DEFAULT '0' NOT NULL,
		`datestamp` INT UNSIGNED DEFAULT '0' NOT NULL,
		`order` SMALLINT UNSIGNED NOT NULL,
		`access` VARCHAR(255) NOT NULL DEFAULT '',
		PRIMARY KEY (`id`)
